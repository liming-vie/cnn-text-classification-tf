...
class Processor(Iface, TProcessor):
  ...
  def process_run(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = run_result()
    result.success = self._handler.run(args.query)
...
class run_result:
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(DisABResponse, DisABResponse.thrift_spec)), None, ), # 0
  )
